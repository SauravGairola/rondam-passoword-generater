...
void generate_password(int length)
{
    ...
    while (count < length) {
        ...
        //so the string that should be selected is  alphabet or(i.e 1 )
        ...
        case 1:
            ...
            if ((count_alphabet == 1) && (count_number == 0 || count_ALPHABET == 0 || count_ALPHABET == 0 || count_s_symbol == 0))
                break;
            key = getKey();
        ...
        case 3:
            ...
            // in case it has been fulfilled and minimum requirements of
            // other characters is still left then it will break ;
            if ((count_number == 2) && (count_alphabet == 0 || count_alphabet == 1 || count_ALPHABET == 1 || count_ALPHABET == 0 || count_s_symbol == 0))
                break;
            key = getKey();
            key = key % 10;
        ...
        case 4:
            ...
            // in case it has been fulfilled and minimum requirements of
            // other characters is still left then it will break ;
            if ((count_s_symbol == 2) && (count_alphabet == 0 || count_alphabet == 1 || count_ALPHABET == 0 || count_ALPHABET == 1 || count_number == 1))
                break;
            key = getKey();
            key = key % 6;
